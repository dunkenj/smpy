...
class Fitting(object):
    ...
    def __init__(self, observations, models, ncpus=1):
        ...
        self.models = models
        self.tg = self.models.info['tg']
        self.tv = self.models.info['Av']
        self.tau = self.models.info['SFH']
        self.SSP = self.models.info['Metallicities']
        self.fesc = self.models.info['fesc']
